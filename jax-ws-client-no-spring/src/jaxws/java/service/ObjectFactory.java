 ...
 * generated in the jaxws.java.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeById_QNAME = new QName("http://service.java.jaxws/", "getEmployeeById");
    private final static QName _GetEmployeeByIdResponse_QNAME = new QName("http://service.java.jaxws/", "getEmployeeByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jaxws.java.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.java.jaxws/", name = "getEmployeeById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.java.jaxws/", name = "getEmployeeByIdResponse")
